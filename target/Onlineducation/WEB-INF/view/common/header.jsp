...
<meta charset="utf-8">
<title>头部</title>
<link href="/Onlineducation/style/css/common/header.css"
	rel="stylesheet">
<link href="/Onlineducation/style/css/common/iconn.css" rel="stylesheet">
<script src="/Onlineducation/style/js/jquery.min.js"></script>
<link href="/Onlineducation/style/images/favicon.ico"
	rel="SHORTCUT ICON">
<meta name="Keywords"
			...
			<div class="nav_main">
				...
				<div class="mymall"
					...
					<ul class="quick_li" style="line-height: 30px;">
						...
						<li><a
							href="http://www.jkj521.cn/AccountingOnline/page/login">在线会计</a></li>
					</ul>
				</div>
			</div>
		</div>
								...
								<div class="fl search-input">
									<div>
										<input type="text" class="fl" placeholder="搜索 课程/名称"
											name="product_name" data-isshow="1" data-where="1">
									</div>
								</div>
								<input type="submit"
