$(function () {
    ...
    $("#nav_tools_admin_logout").click(function () {
        location.href = "/Onlineducation/admin/account/logout";
    });
});
//tbody中tr的单击样式
...
function createPageDiv(obj, pageUtil) {
    ...
    pageDiv.append("<ul><li data-name='firstPage'><a href='javascript:void(0)' onclick='getPage(0)' aria-label='管理首页'><span aria-hidden='true'>&laquo;</span></a></li><li data-name='prevPage'><a href='javascript:void(0)' onclick='getPage(" + (pageUtil.index - 1) + ")' aria-label='上一页'><span aria-hidden='true'>&lsaquo;</span></a></li></ul>");
