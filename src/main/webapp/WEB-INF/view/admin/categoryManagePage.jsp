    ...
    <script>
        ...
        $(function () {
            ...
            $("#btn_category_submit").click(function () {
                ...
                getData($(this), "/Onlineducation/admin/category/0/10", dataList);
            });
            //点击刷新按钮时
            $("#btn_category_refresh").click(function () {
                ...
                //获取数据
                getData($(this), "/Onlineducation/admin/category/0/10", null);
            });
            //点击table中的数据时
        ...
        function getPage(index) {
            getData($(this), "/Onlineducation/admin/category/" + index + "/10", dataList);
        }
        ...
        function deleteCategory() {
            ...
            if (arr === undefined || arr.length == 0) {
                ...
                if (window.confirm("确认删除？")) {
                    $.ajax({
                        url: "/Onlineducation/admin/category/delete/" + arr,
                        type: "get",
                        date: null,
                        traditional: true,
                        success: function (data) {
