...
<head>
    <script>
            ...
            if ($("#details_category_id").val() === "") {
                ...
                $("#btn_category_save").click(function () {
                   ...
                   /* if (category_image_src === "" || category_image_src === undefined) {
                    ...
                    doAction(dataList, "/Onlineducation/admin/category", "POST");
                });
            } else {
                //设置分类编号
                $("#span_category_id").text('${requestScope.category.id}');
                //判断文件是否允许上传
                ...
                $("#btn_category_save").click(function () {
                    ...
                    doAction(dataList, "/Onlineducation/admin/category/" + category_id, "POST");
                });
            }
        ...
        function uploadImage(fileDom) {
            ...
            //上传图片
            $.ajax({
                url: "/Onlineducation/admin/uploadCategoryImage",
                type: "post",
                data: formData,
                contentType: false,
                processData: false,
...
<div class="details_div_first">
    <input type="hidden" value="${requestScope.category.id}" id="details_category_id"/>
    <div class="frm_div">
