		...
		<c:forEach items="${requestScope.categoryList}" var="category">		
			<div class="course-list clearfix" id="float01">				
				...
				<div class="con clearfix" style="display: block;">
					<ul class="clearfix">
						<c:forEach items="${requestScope.courseMap}" var="courseMap">							
							<c:if test='${courseMap.key eq category.id}'>
								<c:forEach items="${courseMap.value}" var="course" varStatus="index">								
									<c:choose>										
										<c:when test="${index.index }&lt;8">
											<li>
												<div class="pic">
